...
public enum CodeEnum {
    ...
    HHTC_SMS_SEND_FAIL_1  (3020, "短信发送失败：每分钟只能发送一条"),
    HHTC_SMS_SEND_FAIL_5  (3021, "短信发送失败：每小时最多发送五条"),
    HHTC_SMS_SEND_FAIL_10 (3022, "短信发送失败：每天最多发送十条");
