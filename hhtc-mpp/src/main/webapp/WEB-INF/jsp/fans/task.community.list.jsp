...
function audit(id, flag){
    if(confirm("确定审核 [ " + (flag==1 ? "通过" : "拒绝") +" ] 此地址请求么？")){
        if(flag==1 || (flag==2 && inputRemark())){
            $.post("${ctx}/fans/Audit",
                ...
                function(data){
                    if(0 == data.code){
                        alert("操作成功");
                        location.href = "${ctx}/fans/task/community/list";
                    }else{
...
<div class="c_content">
    ...
    <!--/Table list-->
    <jsp:include page="../comm/page.jsp?requestURI=${ctx}/fans/task/community/list"/>
</div>
<!--/Content-->
