...
<div class="c_content">
    <c:if test="${user.type eq 1}">
        ...
        <div class="title txt_r">
            <span class="sch2" style="margin-right:50px;">
                ...
                &nbsp;
                <input class="inpte Wdate" style="width:85px" type="text" id="from_date" maxlength="8" onFocus="WdatePicker({readOnly:true, dateFmt:'yyyyMMdd'})"/>
                &nbsp;&nbsp;-&nbsp;&nbsp;
                <input class="inpte Wdate" style="width:85px" type="text" id="end_date" maxlength="8" onFocus="WdatePicker({readOnly:true, dateFmt:'yyyyMMdd'})"/>
                &nbsp;
    ...
    <!--/Table list-->
    <jsp:include page="../comm/page.jsp?requestURI=${ctx}/communitydeviceflow/list"/>
</div>
<!--/Content-->
