  ...
  <div class="demand">
    ...
    <div class="content">
      ...
      <div class="time_chose fcg43 font32"><!--@click="show('ceng_district')"-->
        <div><span class="l">小区名称:</span><span class="r" >{{nowName.name}}</span></div>
        <div><span class="l">车牌号:</span><span class="r" @click="goRouter('/license_plate')">{{carNumber}}</span></div>
        <div><span class="l">停车日期:</span><span class="r"><input type="text" name="" id="birthday" readonly placeholder="请选择开始时间"></span></div>
...
module.exports={
    ...
    methods:{
      ...
      suer:function(){
        //确认发布
        var beginDay=$("#birthday").val(),endDay=beginDay.replace(/-/g,"/");
        ...
        $.ajax({
          ...
          data:{
            ...
            needFromDate:$("#birthday").val().replace(/-/g,""),
